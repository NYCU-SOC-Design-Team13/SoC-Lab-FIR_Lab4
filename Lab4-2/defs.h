...
#define reg_tap0  (*(volatile uint32_t*)0x30000040)
#define reg_tap1  (*(volatile uint32_t*)0x30000044)
#define reg_tap2  (*(volatile uint32_t*)0x30000048)
#define reg_tap3  (*(volatile uint32_t*)0x3000004c)
#define reg_tap4  (*(volatile uint32_t*)0x30000050)
#define reg_tap5  (*(volatile uint32_t*)0x30000054)
#define reg_tap6  (*(volatile uint32_t*)0x30000058)
#define reg_tap7  (*(volatile uint32_t*)0x3000005c)
#define reg_tap8  (*(volatile uint32_t*)0x30000060)
#define reg_tap9  (*(volatile uint32_t*)0x30000064)
#define reg_tap10 (*(volatile uint32_t*)0x30000068)

#define reg_x_input (*(volatile uint32_t*)0x30000080)
#define reg_y_output (*(volatile uint32_t*)0x30000084)
