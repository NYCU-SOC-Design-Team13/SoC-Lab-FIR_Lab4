...
// taps[n]
#define reg_tap_0      (*(volatile uint32_t*)0x30000040)
#define reg_tap_1      (*(volatile uint32_t*)0x30000044)
#define reg_tap_2      (*(volatile uint32_t*)0x30000048)
#define reg_tap_3      (*(volatile uint32_t*)0x3000004c)
#define reg_tap_4      (*(volatile uint32_t*)0x30000050)
#define reg_tap_5      (*(volatile uint32_t*)0x30000054)
#define reg_tap_6      (*(volatile uint32_t*)0x30000058)
#define reg_tap_7      (*(volatile uint32_t*)0x3000005c)
#define reg_tap_8      (*(volatile uint32_t*)0x30000060)
#define reg_tap_9     (*(volatile uint32_t*)0x30000064)
